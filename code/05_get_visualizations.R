...
save_plot("data/04_rec_cutoff_low.rds", "../text/figuras/3a_cutoff_low_log.png", 3000, log = TRUE)
save_plot("data/03_rec_cutoff_med.rds", "../text/figuras/3b_cutoff_med.png", 3000)
save_plot("data/03_rec_cutoff_med.rds", "../text/figuras/3b_cutoff_med_log.png", 3000, log = TRUE)
save_plot("data/05_rec_cutoff_high.rds", "../text/figuras/3c_cutoff_high.png", 3000)
save_plot("data/05_rec_cutoff_high.rds", "../text/figuras/3c_cutoff_high_log.png", 3000, log = TRUE)

save_plot("data/06_rec_cosine.rds", "../text/figuras/4a_cosine.png", 31000)
save_plot("data/06_rec_cosine.rds", "../text/figuras/4a_cosine_log.png", 31000, log = TRUE)
save_plot("data/07_rec_euclidean.rds", "../text/figuras/4b_euclidean.png", 31000)
save_plot("data/07_rec_euclidean.rds", "../text/figuras/4b_euclidean_log.png", 31000, log = TRUE)
save_plot("data/08_rec_manhattan.rds", "../text/figuras/4c_manhattan.png", 31000)
save_plot("data/08_rec_manhattan.rds", "../text/figuras/4c_manhattan_log.png", 31000, log = TRUE)

save_plot("data/11_rec_p.rds", "../text/figuras/5a_p.png", 200)
save_plot("data/11_rec_p.rds", "../text/figuras/5a_p_log.png", 200, log = TRUE)
save_plot("data/12_rec_p10.rds", "../text/figuras/5b_p10.png", 200)
save_plot("data/12_rec_p10.rds", "../text/figuras/5b_p10_log.png", 200, log = TRUE)
save_plot("data/13_rec_p100.rds", "../text/figuras/5c_p100.png", 200)
save_plot("data/13_rec_p100.rds", "../text/figuras/5c_p100_log.png", 200, log = TRUE)
