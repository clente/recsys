...
titles <- py_to_r(index$call(np$array(list("42")))[[1]][0]$numpy()$tolist())
titles <- purrr::map_chr(titles, ~.x$decode("utf-8"))
print(paste0("Top 3 recommendations for user 42: ", paste0(titles, collapse = ", ")))
