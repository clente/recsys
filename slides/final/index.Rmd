...
learning or developing biases (which might lead to radicalization)
  ...
  cas create **amplification pipelines**
...
- Deep learning TensorFlow model that is trained five times, always receiving
...
- Static analysis
  ...
  - Expectation: a systems's recommendation profile would be approximately the
  same as the original dataset's item popularity distribution
...
- We plan on writing and publishing a paper detailing our findings in late 2023,
possibly adding larger-scale experiments
