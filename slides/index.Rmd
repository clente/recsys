...
subtitle: "_Inescapable Bias: The Role of Recommender Systems in Social Media Radicalization_"
...
- MovieLens, a well-known set of movie reviews

  - F. M. Harper and J. A. Konstan, "The MovieLens Datasets: History and
  Context"
  
  - 27M ratings applied to 58K movies, enriched with information about the
  movies' credits, metadata, keywords, and links

- Book-Crossing Dataset, used for validation purposes only
...
- Exclude user information is important because they might transfer their own
biases to the model
...
for a recommendation and
  ...
  - The "recommendation profile" averaged, evidently, $n$
...
comprised of words sampled at random from the full corpus
  ...
  - The sparser the vectors, the higher the odds of the recommendation curve
  displaying a steep left-hand side
...
gather data about what happens as users follow suggestions
  ...
  - If a similar profile can be detected, then the hypothesis would become even
  more plausible
