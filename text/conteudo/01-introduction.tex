...
noting that most of these platforms' efforts are concentrated in only a few
regions \citep{newton_leaked_2021}, so, even if they actually try and remove the
offending content, most of the world would still not be impacted by their policy
changes.
...
In Chapter~\ref{cap:review}, the authors review the available literature about
