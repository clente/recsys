...
\begin{figure}
  ...
  \begin{subfigure}{0.3\textwidth}
    \centering
    \includegraphics[width=\textwidth]{3a_cutoff_low_log}
    \caption{Log-log plot for $k = 2$.\label{fig:fig3a}}
  \end{subfigure}
  \begin{subfigure}{0.3\textwidth}
    \centering
    \includegraphics[width=\textwidth]{3b_cutoff_med_log}
    \caption{Log-log plot for $k = 5$.\label{fig:fig3b}}
  \end{subfigure}
  \begin{subfigure}{0.3\textwidth}
    \centering
    \includegraphics[width=\textwidth]{3c_cutoff_high_log}
...
\begin{figure}
  ...
  \begin{subfigure}{0.3\textwidth}
    \centering
    \includegraphics[width=\textwidth]{4a_cosine_log}
    \caption{Log-log plot for Cosine.\label{fig:fig4a}}
  \end{subfigure}
  \begin{subfigure}{0.3\textwidth}
    \centering
    \includegraphics[width=\textwidth]{4b_euclidean_log}
    \caption{Log-log plot for Euclidean.\label{fig:fig4b}}
  \end{subfigure}
  \begin{subfigure}{0.3\textwidth}
    \centering
    \includegraphics[width=\textwidth]{4c_manhattan_log}
...
The log-log plots make it clear that these models approach the trivial model as
...
\begin{figure}
  ...
  \begin{subfigure}{0.3\textwidth}
    \centering
    \includegraphics[width=\textwidth]{5a_p_log}
    \caption{Log-log plot for $1 \times \overline{P(w)}$.\label{fig:fig5a}}
  \end{subfigure}
  \begin{subfigure}{0.3\textwidth}
    \centering
    \includegraphics[width=\textwidth]{5b_p10_log}
    \caption{Log-log plot for $10 \times \overline{P(w)}$.\label{fig:fig5b}}
  \end{subfigure}
  \begin{subfigure}{0.3\textwidth}
    \centering
    \includegraphics[width=\textwidth]{5c_p100_log}
