...
systems in general and specifically fair recommendation algorithms. \citet{} % Reinforcement Learning based Recommender Systems: A Survey
and \citet{} both present up-to-date overviews about the field, while  % A Survey of Recommendation Systems: Recommendation Models, Techniques, and Application Fields
\citet{}, \citet{}, and \citet{} focus on explainable recommenders and fairness
metrics.
% Fairness in Recommender Systems: Research Landscape and Future Directions
% A Survey on the Fairness of Recommender Systems
% Fairness in Recommendation: A Survey

Many novel algorithms were also developed during the elaboration of this work.
\citet{}, \citet{}, \citet{}, \citet{}, \citet{}, \citet{}, \citet{}, and
\citet{} all present either new fairer recommender systems or new metrics that
can be used to rank existing algorithms on their bias.
...
Furthermore, some researchers have found evidence of other possible mechanisms
through which users can become radicalized. \citet{} flips our hypothesis on its % Sharing of misinformation is habitual, not just lazy or biased
head, arguing that recommendation systems encourage content creators (not
consumers) to make ever more extreme content in order to attract more attention
that their competitors. \citet{} goes one step further and finds that some users % Do Humans Prefer Debiased AI Algorithms? A Case Study in Career Recommendation
might actually prefer biased algorithms. Finally, \citet{} removes the % The Small but Mighty Danger of Echo Chamber Extremism
algorithmic component almost entirely, claiming that real-world engagement is
the biggest radicalizer of all.
