...
We experimented on five variations to the vanilla model and of the original
...
\citet{naghiaei_cpfair_2022}, \citet{ovaisi_rgrecsys_2022},
\citet{gao_fair_2022}, \citet{patro_fair_2022}, \citet{ge_explainable_2022},
\citet{yu_self-supervised_2022}, \citet{liu_dual_2022}, and
\citet{wang_trustworthy_2022} all present either new fairer recommender systems
or new metrics that can be used to rank existing algorithms on their bias.

Furthermore, some researchers have found evidence of other possible mechanisms
through which users can become radicalized. \citet{ceylan_sharing_2023} flips
our hypothesis on its head, arguing that recommendation systems encourage
content creators (not consumers) to make ever more extreme content in order to
attract more attention that their competitors. \citet{wang_humans_2022} goes one
step further and finds that some users might actually prefer biased algorithms.
Finally, \citet{benson_small_nodate} removes the algorithmic component almost
entirely, claiming that real-world engagement is the biggest radicalizer of all.
...
% Abrir o repositório antes da defesa

% Quando incorporar os comentários da banca, voltar em folhas-de-rosto.tex e
% colocar \pagrostoime[eng]{definitiva}
