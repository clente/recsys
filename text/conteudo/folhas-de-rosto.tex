...
\tituloport{Canais de Amplificação}

% Se "\title" está em português, você pode definir o título em inglês aqui;
% caso contrário, remova
% \tituloeng{Amplification Pipelines}

% Se o trabalho não tiver subtítulo, basta remover isto.
\subtitulo{O Papel da Retroalimentação no Viés de Sistemas de Recomendação}

% Se isto não for definido, "\subtitulo" é utilizado no lugar
\subtituloeng{The Role of Feedback Loops in Recommender System Bias}
...
\datadefesa{24 de maio de 2023}

% Se isto não for definido, "\datadefesa" é utilizado no lugar
\datadefesaeng{May 24th, 2023}
...
\banca{
  \begin{itemize}
    \item Prof. Dr. Roberto Hirata Jr. (orientadora) -- IME-USP
    \item Prof. Dr. Alexandre Galvão Patriota -- IME-USP
    \item Prof. Dr. Fabrício Murai Ferreira -- UFMG
  \end{itemize}
}
